        ...
        child: Column(
          ...
          children: [
            TextButton.icon(
              ...
              label: const Text('Contact the Developer on LinkedIn'),
              icon: Image.asset('assets/linkedin.png'),
              onPressed: () {
                const url = 'https://www.linkedin.com/in/abdullah-al-hakimi-465025221';
                _launchURL(url);
              },
            ),
            TextButton.icon(
              ...
              label: const Text('Contact the Developer on WhatsApp'),
            ...
            TextButton.icon(
              ...
              onPressed: () {
                const url = 'https://play.google.com/store/apps/details?id=com.medicine_reminder.medicine_reminder';
                _launchURL(url);
              },
            ),
          ],
