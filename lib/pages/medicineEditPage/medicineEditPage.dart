...
class _MedicineAddPageState extends State<MedicineEditPage> {
  ...
  Widget build(BuildContext context) {
    ...
    String intSupplyCurrent = NumberFormat("#.##", "en_US").format(supplyCurrent);
    String intSupplyMin = NumberFormat("#.##", "en_US").format(supplyMin);
    String intDose = NumberFormat("#.##", "en_US").format(dose);
    String intCapSize = NumberFormat("#.##", "en_US").format(capSize);
